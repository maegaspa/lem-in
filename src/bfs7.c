...
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2020/02/10 15:51:36 by cgarrot      #+#   ##    ##    #+#       */
/*   Updated: 2020/02/10 15:51:37 by cgarrot     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void	clear_path(t_res *res, t_sort *sort, int step)
{
	...
	if (res->used_paths > dis.i)
	{
		sort->first_path[0] = res->paths[dis.i];
		sort->new_size_first[0] = res->size_paths[dis.i];
	}
