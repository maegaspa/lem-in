...
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2020/01/30 16:42:55 by seanseau     #+#   ##    ##    #+#       */
/*   Updated: 2020/01/30 17:59:39 by seanseau    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void			ft_occur2(t_dispa dis, t_sort *s, t_res *res)
{
...
void			ft_occur(t_dispa dis, t_sort *s, t_res *res)
{
	if (dis.error == 1)
	{
